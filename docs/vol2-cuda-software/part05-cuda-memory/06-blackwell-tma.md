# 5.9B Blackwell TMA：Hopper TMA 的功能扩展
...
## 5.9B.2 Bulk copy：Blackwell 仍保留的基础
...
## 5.9B.6 `tile::gather4` 与 `tile::scatter4`
...
## 5.9B.8 `im2col::w` 与 `im2col::w::128`
