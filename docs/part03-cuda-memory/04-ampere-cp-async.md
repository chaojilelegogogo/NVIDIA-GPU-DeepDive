...
`commit_group/wait_group`、warp entanglement 和跨线程交接的完整同步语义见[第十三部分 Async Pipeline Synchronization](../part13-synchronization-handbook/03-async-pipelines.md)；流水线调度与 latency hiding 见[第四部分执行流水线](../part04-execution-pipeline.md)。
